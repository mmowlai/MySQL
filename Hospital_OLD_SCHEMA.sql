DROP DATABASE IF EXISTS `sql_HOSPITAL_OLD`;
CREATE DATABASE `sql_HOSPITAL_OLD`;
...
CREATE TABLE `Appointment` (
  `AppointmentID` BIGINT PRIMARY KEY NOT NULL,
  `Patient` BIGINT NOT NULL,    
  `PrepNurse` BIGINT,
  `Physician` BIGINT NOT NULL,
  `Start` DATETIME NOT NULL,
  `End` DATETIME NOT NULL,
  `ExaminationRoom` LONGTEXT NOT NULL,
...
CREATE TABLE `Block` (
  `BlockFloor` BIGINT NOT NULL,
  `BlockCode` BIGINT NOT NULL,
...
CREATE TABLE `Stay` (
  `StayID` BIGINT PRIMARY KEY NOT NULL,
  `Patient` BIGINT NOT NULL,
